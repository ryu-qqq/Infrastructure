...
# Note: If upgrading from previous version, the IAM role resource was renamed
# from aws_iam_role.grafana-workspace to module.iam_grafana_workspace
# Manual state migration may be required

module "iam_grafana_workspace" {
  source = "../../../modules/iam-role-policy"

  role_name   = local.iam_roles.grafana_workspace
