...
output "cloudtrail_bucket_id" {
  ...
  value       = module.cloudtrail_logs_bucket.bucket_id
}

output "cloudtrail_bucket_arn" {
  description = "The ARN of the S3 bucket for CloudTrail logs"
  value       = module.cloudtrail_logs_bucket.bucket_arn
}

output "athena_results_bucket_id" {
  description = "The ID of the S3 bucket for Athena query results"
  value       = var.enable_athena ? module.athena_results_bucket[0].bucket_id : null
}
...
output "cloudtrail_summary" {
  ...
  value = {
    ...
    s3_bucket               = module.cloudtrail_logs_bucket.bucket_id
