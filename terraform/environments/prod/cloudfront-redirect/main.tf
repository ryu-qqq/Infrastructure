...
# Redirects server.set-of.net to www.set-of.com
...
# ACM Certificate validation (ensure it's issued)
...
resource "aws_cloudfront_function" "redirect" {
  name    = "redirect-server-to-www"
  runtime = "cloudfront-js-2.0"
  publish = true
  comment = "Redirects server.set-of.net to www.set-of.com with path preservation"
